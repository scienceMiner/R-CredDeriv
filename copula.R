...
x <- seq(0.0000000000001,0.999999999999999,length=n)
y <- seq(0.0000000000001,0.999999999999999,length=n)
...
persp(x,y,gaussian.copula(x,y,0.1),axes=TRUE,scale=TRUE,shade=.5,border=1,expand=.4,zlab="",ticktype="detailed",main="Gaussian Copula")
