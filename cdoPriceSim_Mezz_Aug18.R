...
{
	return(CDOPrice(100,rec,0.01,correl,1,1,trancheLow,trancheHigh,0.04,sims,1))
...
rec=matri[c1];
correl=matri[c2];
	return(c((CDOPrice(100,rec,0.01,correl,1,1,trancheLow,trancheHigh,0.04,sims,1))))
...
spreads <- apply(m1,1, simCDO2, c1="s1", c2="t1", trancheLow=0.09, trancheHigh=0.22, sims=10000)
