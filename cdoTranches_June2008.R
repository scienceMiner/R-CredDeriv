...
CDOvals <- apply(m1,1, simCDO, c1="s1", c2="t1",10000,50)

CDOvals

trellis.par.set("axis.line", list(col="transparent"),
	clip = list(panel = "off"))
trellis.par.set(axis.las=3)
...
fig5 <- wireframe(CDOvals[3,] ~ t1 * s1, #g,
	...
	colorkey = FALSE,
	xlab = "Factor Sensitivity",
	ylab = expression(paste(LGD)),
	zlab = list(las=3,label = "Default Probability",font = 1, rot = 90),
	split = c(1,1,2,1),
	zlim = range(seq(0.00,0.05,by=0.01))
)
