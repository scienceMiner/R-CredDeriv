...
#This R program can be used to download option price data from Yahoo to a 
#data frame and to plot the corresponding implied-volatility smiles. 
#Requires package 'fCalendar'. After downloading and sourcing the file 
